...
import (
	...
	"github.com/Neakxs/protocel/testdata/authorize/advanced"
	"github.com/Neakxs/protocel/testdata/authorize/basic"
	"github.com/Neakxs/protocel/testdata/authorize/crossref"
	"github.com/Neakxs/protocel/testdata/authorize/extended"
	"github.com/Neakxs/protocel/testdata/authorize/invalid"
...
func TestGenerate(t *testing.T) {
	tests := []struct {
		...
		{
			Name:    "Basic",
			Desc:    []protoreflect.FileDescriptor{basic.File_testdata_authorize_basic_basic_proto},
			WantErr: false,
		},
		{
			Name:    "Advanced",
			Desc:    []protoreflect.FileDescriptor{advanced.File_testdata_authorize_advanced_advanced_proto},
			WantErr: false,
		},
		{
			Name:    "Extended",
			Desc:    []protoreflect.FileDescriptor{extended.File_testdata_authorize_extended_extended_proto},
			WantErr: false,
		},
		{
			Name:    "Crossref",
			Desc:    []protoreflect.FileDescriptor{crossref.File_testdata_authorize_crossref_crossref_proto, basic.File_testdata_authorize_basic_basic_proto},
			WantErr: false,
		},
		{
			Name:    "Invalid",
			Desc:    []protoreflect.FileDescriptor{invalid.File_testdata_authorize_invalid_invalid_proto},
			WantErr: true,
		},
	}
